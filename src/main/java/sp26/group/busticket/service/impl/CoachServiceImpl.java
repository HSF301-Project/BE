...
import sp26.group.busticket.dto.coach.response.TripHistoryDTO;
import sp26.group.busticket.dto.trip.response.AdminSeatStatusDTO;
...
import sp26.group.busticket.mapper.CoachMapper;
import sp26.group.busticket.repository.*;
import sp26.group.busticket.service.CoachService;
...
public class CoachServiceImpl implements CoachService {
    ...
    public CoachDetailResponseDTO getCoachDetails(UUID id) {
        ...
        List<Trip> trips = tripRepository.findAllTripsByCoach(id);
    ...
    private List<TripStopEtaDTO> buildStopEtas(Trip trip,
    ...
    @Override
    public CoachType saveCoachType(CoachType coachType) {
    ...
    @Override
    public CoachType getCoachTypeById(UUID id) {
    ...
    private String translateCoachStatus(CoachStatusEnum status) {
