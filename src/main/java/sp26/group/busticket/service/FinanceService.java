...
import sp26.group.busticket.dto.finance.response.FinanceDashboardResponseDTO;
import sp26.group.busticket.dto.finance.response.TransactionResponseDTO;
...
public class FinanceService {
    ...
    private TransactionResponseDTO mapToTransactionResponseDTO(Payment payment) {
        String statusLabel = switch (payment.getStatus()) {
            case PAID -> "Thành công";
            case CANCELLED -> "Thất bại";
